...
CLASSPATH="$CLASSPATH:$PROJ_ROOT/jars/jung-3d-demos-2.0.jar"
CLASSPATH="$CLASSPATH:$PROJ_ROOT/jars/jung-algorithms-2.0.jar"
CLASSPATH="$CLASSPATH:$PROJ_ROOT/jars/jung-api-2.0-tests.jar"
...
CLASSPATH="$CLASSPATH:$PROJ_ROOT/jars/jung-jai-samples-2.0.jar"
CLASSPATH="$CLASSPATH:$PROJ_ROOT/jars/jung-samples-2.0.jar"
